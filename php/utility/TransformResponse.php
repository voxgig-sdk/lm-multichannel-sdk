...
// LmMultichannel SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class LmMultichannelTransformResponse
{
    public static function call(LmMultichannelContext $ctx): mixed
    {
        ...
        $transform = LmMultichannelHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
