...
// LmMultichannel SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class LmMultichannelMakeRequest
{
    public static function call(LmMultichannelContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new LmMultichannelResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new LmMultichannelResponse($fetched);
        } else {
