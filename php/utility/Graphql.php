...
// LmMultichannel SDK utility: graphql
//
...
class LmMultichannelGraphql
{
    ...
    // equivalent.
    public static function body(LmMultichannelContext $ctx): mixed
    {
    ...
    public static function errors(LmMultichannelContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
