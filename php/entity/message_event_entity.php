...
// LmMultichannel SDK MessageEvent entity
...
class MessageEventEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MessageEventEntity($this->_client, $opts);
    }

    /**
     * @param MessageEvent|array $args MessageEvent data (assoc-array) to store.
     */
    ...
    /**
     * @return MessageEvent|array The current MessageEvent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MessageEvent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MessageEvent fields).
     */
    ...
    /**
     * List MessageEvent items matching the given filter.
     *
     * @param MessageEventListMatch|array|null $reqmatch Match filter (any subset
     *   of MessageEvent fields) as an assoc-array; MessageEventListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MessageEvent[]|array A list of MessageEvent items as assoc-arrays at
