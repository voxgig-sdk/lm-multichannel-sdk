...
// LmMultichannel SDK Traffic entity
...
class TrafficEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TrafficEntity($this->_client, $opts);
    }

    /**
     * @param Traffic|array $args Traffic data (assoc-array) to store.
     */
    ...
    /**
     * @return Traffic|array The current Traffic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Traffic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Traffic fields).
     */
    ...
    /**
     * Remove an Traffic matching the given criteria.
     *
     * @param TrafficRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; TrafficRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Traffic|array The removed Traffic as an assoc-array at the
