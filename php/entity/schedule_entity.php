...
// LmMultichannel SDK Schedule entity
...
class ScheduleEntity
{
    ...
    /**
     * Remove an Schedule matching the given criteria.
     *
     * @param ScheduleRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ScheduleRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Schedule|array The removed Schedule as an assoc-array at the
     *   SDK boundary; throws LmMultichannelError on failure (item-5 convention).
     */
