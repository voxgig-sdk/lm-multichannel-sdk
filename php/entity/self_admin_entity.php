...
// LmMultichannel SDK SelfAdmin entity
...
class SelfAdminEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SelfAdminEntity($this->_client, $opts);
    }

    /**
     * @param SelfAdmin|array $args SelfAdmin data (assoc-array) to store.
     */
    ...
    /**
     * @return SelfAdmin|array The current SelfAdmin data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SelfAdmin fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SelfAdmin fields).
     */
    ...
    /**
     * Update an existing SelfAdmin.
     *
     * @param SelfAdminUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SelfAdminUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SelfAdmin|array The updated SelfAdmin as an assoc-array at the
