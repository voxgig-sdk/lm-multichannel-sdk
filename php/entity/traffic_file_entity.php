...
// LmMultichannel SDK TrafficFile entity
...
class TrafficFileEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TrafficFileEntity($this->_client, $opts);
    }

    /**
     * @param TrafficFile|array $args TrafficFile data (assoc-array) to store.
     */
    ...
    /**
     * @return TrafficFile|array The current TrafficFile data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TrafficFile fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TrafficFile fields).
     */
    ...
    /**
     * Load a single TrafficFile.
     *
     * @param TrafficFileLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TrafficFileLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TrafficFile|array The loaded TrafficFile as an assoc-array at the
    ...
    /**
     * List TrafficFile items matching the given filter.
     *
     * @param TrafficFileListMatch|array|null $reqmatch Match filter (any subset
     *   of TrafficFile fields) as an assoc-array; TrafficFileListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TrafficFile[]|array A list of TrafficFile items as assoc-arrays at
