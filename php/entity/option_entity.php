...
class OptionEntity
{
     ...
     * Create a new Option.
     *
     * @param OptionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OptionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Option|array The created Option as an assoc-array at the
     *   SDK boundary; throws LmMultichannelError on failure (item-5 convention).
     */
     ...
     *
     * @param OptionUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OptionUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Option|array The updated Option as an assoc-array at the
     *   SDK boundary; throws LmMultichannelError on failure (item-5 convention).
     */
