...
// LmMultichannel SDK Self entity
...
class SelfEntity
{
     ...
     * Load a single Self.
     *
     * @param SelfLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SelfLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Self|array The loaded Self as an assoc-array at the
