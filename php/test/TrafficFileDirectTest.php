...
{
    public function test_direct_list_traffic_file(): void
    {
        $setup = traffic_file_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-traffic_file", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
