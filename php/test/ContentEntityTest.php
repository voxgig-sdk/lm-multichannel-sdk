...
class ContentEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LMMULTICHANNEL_TEST_CONTENT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function content_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LMMULTICHANNEL_TEST_CONTENT_ENTID");
