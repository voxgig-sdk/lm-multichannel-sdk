...
// LmMultichannel SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (LmMultichannelSDK::test)
...
{
    private const SDK_CLASS = 'LmMultichannelSDK';
    ...
    private const SDK_BASE = 'lmmultichannel_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../lmmultichannel_sdk.php';
