...
class VariableDirectTest extends TestCase
{
    public function test_direct_list_variable(): void
    {
        $setup = variable_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-variable", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
