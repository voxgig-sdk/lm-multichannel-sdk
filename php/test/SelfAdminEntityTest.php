...
class SelfAdminEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LMMULTICHANNEL_TEST_SELF_ADMIN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $self_admin_ref01_resdata_up0 = Helpers::to_map($self_admin_ref01_resdata_up0_result);
...
function self_admin_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LMMULTICHANNEL_TEST_SELF_ADMIN_ENTID");
