...
// LmMultichannel SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = LmMultichannelOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(LmMultichannelOmni::structfix($now, Struct::undef()))
                        !== json_encode(LmMultichannelOmni::structfix($val, Struct::undef()))) {
