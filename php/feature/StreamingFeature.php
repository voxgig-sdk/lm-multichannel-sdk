...
// LmMultichannel SDK streaming feature
...
class LmMultichannelStreamingFeature extends LmMultichannelBaseFeature
{
    ...
    private function _iterate(LmMultichannelResult $result): \Generator
    {
    ...
    private function _streamable(LmMultichannelContext $ctx): bool
    {
