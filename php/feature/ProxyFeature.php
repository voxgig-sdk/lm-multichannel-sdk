...
// LmMultichannel SDK proxy feature
...
class LmMultichannelProxyFeature extends LmMultichannelBaseFeature
{
    ...
    public function init(LmMultichannelContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (LmMultichannelContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
