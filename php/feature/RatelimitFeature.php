...
// LmMultichannel SDK ratelimit feature
...
class LmMultichannelRatelimitFeature extends LmMultichannelBaseFeature
{
    ...
    private function _acquire(LmMultichannelContext $ctx): void
    {
    ...
    private function _track(LmMultichannelContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
