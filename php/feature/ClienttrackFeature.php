...
// LmMultichannel SDK clienttrack feature
...
class LmMultichannelClienttrackFeature extends LmMultichannelBaseFeature
{
    ...
    public function PostConstruct(LmMultichannelContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'LmMultichannel-SDK';
