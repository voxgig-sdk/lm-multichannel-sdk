...
// LmMultichannel SDK netsim feature
...
class LmMultichannelNetsimFeature extends LmMultichannelBaseFeature
{
    ...
    private function _simulate(LmMultichannelContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(LmMultichannelContext $ctx, array $applied): void
    {
        $client = $this->client;
