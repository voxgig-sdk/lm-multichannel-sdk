...
// LmMultichannel SDK utility type

class LmMultichannelUtility
{
    ...
    public static function copy(LmMultichannelUtility $src): LmMultichannelUtility
    {
        $u = new LmMultichannelUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
