...
func registerTools(server *mcp.Server, client *sdk.LmMultichannelSDK) {
	mcp.AddTool(server, &mcp.Tool{
		...
		Description: "List records from LmMultichannel. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		...
		Description: "Load a single record from LmMultichannel. " +
...
func runOp(client *sdk.LmMultichannelSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
