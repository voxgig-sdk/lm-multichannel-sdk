...
describe("TrafficEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set LMMULTICHANNEL_TEST_TRAFFIC_ENTID JSON to run live")
      return
    end
...
function traffic_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("LMMULTICHANNEL_TEST_TRAFFIC_ENTID")
