...
describe("TemplateEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set LMMULTICHANNEL_TEST_TEMPLATE_ENTID JSON to run live")
      return
    end
    ...
    local template_ref01_markdef_up0_name = "created_on"
...
function template_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("LMMULTICHANNEL_TEST_TEMPLATE_ENTID")
