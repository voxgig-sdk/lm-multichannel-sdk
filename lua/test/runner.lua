...
function runner.env_override(m)
  local live = runner.getenv("LMMULTICHANNEL_TEST_LIVE")
  local override = runner.getenv("LMMULTICHANNEL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("LMMULTICHANNEL_TEST_EXPLAIN")
