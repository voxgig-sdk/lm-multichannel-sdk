...
describe("SelfDirect", function()
  it("should direct-load-self", function()
    local setup = self_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-self", setup.live and "live" or "unit")
