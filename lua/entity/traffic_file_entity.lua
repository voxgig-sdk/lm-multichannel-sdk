...
local TrafficFileEntity = {}
TrafficFileEntity.__index = TrafficFileEntity


function TrafficFileEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TrafficFileEntity)
  self._name = "traffic_file"
  self._client = client
...
function TrafficFileEntity:get_name()
  return self._name
end


function TrafficFileEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TrafficFileEntity.new(self._client, opts)
end
...
function TrafficFileEntity:mark_deleted()
  self._deleted = true
end


function TrafficFileEntity:deleted()
  return true == self._deleted
end


function TrafficFileEntity:data_set(args)
  if args ~= nil then
...
function TrafficFileEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TrafficFileEntity:match_set(args)
  if args ~= nil then
...
function TrafficFileEntity:match_get()
...
function TrafficFileEntity:stream(action, args, callopts)
...
---@param reqmatch TrafficFileLoadMatch
---@param ctrl? table
---@return TrafficFile
---@return string? err
function TrafficFileEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch TrafficFileListMatch
---@param ctrl? table
---@return TrafficFile[]
---@return string? err
function TrafficFileEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function TrafficFileEntity:_run_op(ctx, post_done)
  local utility = self._utility
