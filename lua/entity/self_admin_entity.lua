...
local SelfAdminEntity = {}
SelfAdminEntity.__index = SelfAdminEntity


function SelfAdminEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SelfAdminEntity)
  self._name = "self_admin"
  self._client = client
...
function SelfAdminEntity:get_name()
  return self._name
end


function SelfAdminEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SelfAdminEntity.new(self._client, opts)
end
...
function SelfAdminEntity:mark_deleted()
  self._deleted = true
end


function SelfAdminEntity:deleted()
  return true == self._deleted
end


function SelfAdminEntity:data_set(args)
  if args ~= nil then
...
function SelfAdminEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SelfAdminEntity:match_set(args)
  if args ~= nil then
...
function SelfAdminEntity:match_get()
...
function SelfAdminEntity:stream(action, args, callopts)
...
---@param reqdata SelfAdminUpdateData
---@param ctrl? table
---@return SelfAdmin
---@return string? err
function SelfAdminEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function SelfAdminEntity:_run_op(ctx, post_done)
  local utility = self._utility
