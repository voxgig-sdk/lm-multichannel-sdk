...
const testSeed = `map[string]any{"entity": map[string]any{"content": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "message_event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "option": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "schedule": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "self": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "self_admin": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "template": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "traffic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "traffic_file": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "variable": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
