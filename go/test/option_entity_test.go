...
func TestOptionEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		optionRef01Data = core.ToMapAny(entityData(optionRef01DataResult))
		...
		optionRef01ResdataUp0 := core.ToMapAny(entityData(optionRef01ResdataUp0Result))
...
func optionBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("LM_MULTICHANNEL_TEST_OPTION_ENTID")
