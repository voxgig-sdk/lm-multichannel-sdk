...
func NewMessageEventEntity(client *core.LmMultichannelSDK, entopts map[string]any) *MessageEventEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MessageEventEntity) GetName() string { return e.name }
...
func (e *MessageEventEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MessageEventEntity) Deleted() bool {
	return e.deleted
}


func (e *MessageEventEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMessageEventEntity(e.client, opts)
}

func (e *MessageEventEntity) Data(args ...any) any {
...
func (e *MessageEventEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MessageEvent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MessageEventEntity) DataTyped(data ...MessageEvent) MessageEvent {
	if len(data) > 0 {
		return typedFrom[MessageEvent](e.Data(asMap(data[0])))
	}
	return typedFrom[MessageEvent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MessageEvent (all fields
// optional at the wire level).
func (e *MessageEventEntity) MatchTyped(match ...MessageEvent) MessageEvent {
	if len(match) > 0 {
		return typedFrom[MessageEvent](e.Match(asMap(match[0])))
	}
	return typedFrom[MessageEvent](e.Match())
}
...
func (e *MessageEventEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MessageEventEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *MessageEventEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MessageEventListMatch and returns []MessageEvent. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MessageEventEntity) ListTyped(reqmatch MessageEventListMatch, ctrl map[string]any) ([]MessageEvent, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[MessageEvent](res), nil
}



func (e *MessageEventEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MessageEventEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MessageEventEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MessageEventEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
