...
func NewSelfEntity(client *core.LmMultichannelSDK, entopts map[string]any) *SelfEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SelfEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SelfLoadMatch and returns an Self. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SelfEntity) LoadTyped(reqmatch SelfLoadMatch, ctrl map[string]any) (Self, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Self{}, err
	}
	return typedFrom[Self](res), nil
}
