...
func NewVariableEntity(client *core.LmMultichannelSDK, entopts map[string]any) *VariableEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VariableEntity) GetName() string { return e.name }
...
func (e *VariableEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VariableEntity) Deleted() bool {
	return e.deleted
}


func (e *VariableEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVariableEntity(e.client, opts)
}

func (e *VariableEntity) Data(args ...any) any {
...
func (e *VariableEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Variable; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VariableEntity) DataTyped(data ...Variable) Variable {
	if len(data) > 0 {
		return typedFrom[Variable](e.Data(asMap(data[0])))
	}
	return typedFrom[Variable](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Variable (all fields
// optional at the wire level).
func (e *VariableEntity) MatchTyped(match ...Variable) Variable {
	if len(match) > 0 {
		return typedFrom[Variable](e.Match(asMap(match[0])))
	}
	return typedFrom[Variable](e.Match())
}
...
func (e *VariableEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VariableEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *VariableEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VariableListMatch and returns []Variable. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *VariableEntity) ListTyped(reqmatch VariableListMatch, ctrl map[string]any) ([]Variable, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Variable](res), nil
}




func (e *VariableEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// VariableCreateData and returns an Variable. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *VariableEntity) CreateTyped(reqdata VariableCreateData, ctrl map[string]any) (Variable, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Variable{}, err
	}
	return typedFrom[Variable](res), nil
}




func (e *VariableEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// VariableUpdateData and returns an Variable. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *VariableEntity) UpdateTyped(reqdata VariableUpdateData, ctrl map[string]any) (Variable, error) {
...
func (e *VariableEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VariableEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
