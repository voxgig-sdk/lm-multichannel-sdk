...
func NewSelfAdminEntity(client *core.LmMultichannelSDK, entopts map[string]any) *SelfAdminEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SelfAdminEntity) GetName() string { return e.name }
...
func (e *SelfAdminEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SelfAdminEntity) Deleted() bool {
	return e.deleted
}


func (e *SelfAdminEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSelfAdminEntity(e.client, opts)
}

func (e *SelfAdminEntity) Data(args ...any) any {
...
func (e *SelfAdminEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SelfAdmin; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SelfAdminEntity) DataTyped(data ...SelfAdmin) SelfAdmin {
	if len(data) > 0 {
		return typedFrom[SelfAdmin](e.Data(asMap(data[0])))
	}
	return typedFrom[SelfAdmin](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SelfAdmin (all fields
// optional at the wire level).
func (e *SelfAdminEntity) MatchTyped(match ...SelfAdmin) SelfAdmin {
	if len(match) > 0 {
		return typedFrom[SelfAdmin](e.Match(asMap(match[0])))
	}
	return typedFrom[SelfAdmin](e.Match())
}
...
func (e *SelfAdminEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SelfAdminEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SelfAdminEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SelfAdminEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *SelfAdminEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SelfAdminUpdateData and returns an SelfAdmin. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *SelfAdminEntity) UpdateTyped(reqdata SelfAdminUpdateData, ctrl map[string]any) (SelfAdmin, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return SelfAdmin{}, err
	}
	return typedFrom[SelfAdmin](res), nil
}



func (e *SelfAdminEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SelfAdminEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
