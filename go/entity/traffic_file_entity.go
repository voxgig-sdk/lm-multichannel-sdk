...
func NewTrafficFileEntity(client *core.LmMultichannelSDK, entopts map[string]any) *TrafficFileEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TrafficFileEntity) Deleted() bool {
	return e.deleted
}


func (e *TrafficFileEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTrafficFileEntity(e.client, opts)
}

func (e *TrafficFileEntity) Data(args ...any) any {
...
func (e *TrafficFileEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TrafficFile; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TrafficFileEntity) DataTyped(data ...TrafficFile) TrafficFile {
	if len(data) > 0 {
		return typedFrom[TrafficFile](e.Data(asMap(data[0])))
	}
	return typedFrom[TrafficFile](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TrafficFile (all fields
// optional at the wire level).
func (e *TrafficFileEntity) MatchTyped(match ...TrafficFile) TrafficFile {
	if len(match) > 0 {
		return typedFrom[TrafficFile](e.Match(asMap(match[0])))
	}
	return typedFrom[TrafficFile](e.Match())
}
...
func (e *TrafficFileEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TrafficFileEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TrafficFileLoadMatch and returns an TrafficFile. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TrafficFileEntity) LoadTyped(reqmatch TrafficFileLoadMatch, ctrl map[string]any) (TrafficFile, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return TrafficFile{}, err
	}
	return typedFrom[TrafficFile](res), nil
}
...
func (e *TrafficFileEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TrafficFileEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
