...
func registerSDKWords(r *eng.Registry, client *sdk.LmMultichannelSDK) {
...
func runOp(client *sdk.LmMultichannelSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
