// Command LmMultichannel-cli is a CLI + REPL for the LmMultichannel SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      LM_MULTICHANNEL_APIKEY (api key), LM_MULTICHANNEL_BASE (base url override)")
