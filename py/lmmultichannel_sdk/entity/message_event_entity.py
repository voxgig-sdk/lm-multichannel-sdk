...
class MessageEventEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MessageEventEntity(self._client, opts)
    ...
    def data_get(self) -> MessageEvent:
    ...
    def match_get(self) -> MessageEvent:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MessageEvent]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MessageEvent().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
