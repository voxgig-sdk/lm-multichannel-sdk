...
class SelfAdminEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SelfAdminEntity(self._client, opts)
    ...
    def update(self, reqdata: SelfAdminUpdateData, ctrl=None) -> SelfAdmin:
        utility = self._utility
