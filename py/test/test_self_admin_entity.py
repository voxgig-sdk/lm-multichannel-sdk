    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set LMMULTICHANNEL_TEST_SELF_ADMIN_ENTID JSON to run live")
        client = setup["client"]
        ...
        self_admin_ref01_resdata_up0 = helpers.to_map(self_admin_ref01_ent.update(self_admin_ref01_data_up0_up, None))
...
def _self_admin_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "LMMULTICHANNEL_TEST_SELF_ADMIN_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("LMMULTICHANNEL_TEST_SELF_ADMIN_ENTID"))
