# LmMultichannel SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions LmMultichannelSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both LmMultichannelSDK(...) and LmMultichannelSDK.test(...) become
#      LmMultichannelSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "lmmultichannel_sdk"
_SDK_CLASS = "LmMultichannelSDK"
