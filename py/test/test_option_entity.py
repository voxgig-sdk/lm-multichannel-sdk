    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set LMMULTICHANNEL_TEST_OPTION_ENTID JSON to run live")
        client = setup["client"]
        ...
        option_ref01_data = helpers.to_map(option_ref01_ent.create(option_ref01_data, None))
        ...
        option_ref01_resdata_up0 = helpers.to_map(option_ref01_ent.update(option_ref01_data_up0_up, None))
...
def _option_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "LMMULTICHANNEL_TEST_OPTION_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("LMMULTICHANNEL_TEST_OPTION_ENTID"))
