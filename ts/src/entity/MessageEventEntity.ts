...
class MessageEventEntity extends LmMultichannelEntityBase<MessageEvent> {
  ...
  constructor(client: LmMultichannelSDK, entopts: any) {
    ...
    this.name = 'message_event'
    this.name_ = 'message_event'
    this.Name = 'MessageEvent'
  }


  make(this: MessageEventEntity) {
    return new MessageEventEntity(this._client, this.entopts())
  }
