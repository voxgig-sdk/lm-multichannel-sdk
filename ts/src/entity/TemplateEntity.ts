...
class TemplateEntity extends LmMultichannelEntityBase<Template> {
  ...
  async list(this: any, reqmatch?: TemplateListMatch, ctrl?: Control): Promise<TemplateEntity[]> {
  ...
  async remove(
    this: any, reqmatch?: TemplateRemoveMatch, ctrl?: Control,
