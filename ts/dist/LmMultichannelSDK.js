"use strict";
// LmMultichannel Ts SDK
Object.defineProperty(exports, "__esModule", { value: true });
exports.SDK = exports.LmMultichannelSDK = exports.LmMultichannelEntityBase = exports.BaseFeature = exports.config = exports.stdutil = void 0;
const ContentEntity_1 = require("./entity/ContentEntity");
const MessageEntity_1 = require("./entity/MessageEntity");
const MessageEventEntity_1 = require("./entity/MessageEventEntity");
...
Object.defineProperty(exports, "LmMultichannelEntityBase", { enumerable: true, get: function () { return LmMultichannelEntityBase_1.LmMultichannelEntityBase; } });
...
class LmMultichannelSDK {
    ...
    async direct(fetchargs) {
        if (!this._options.allow.op.includes('direct')) {
            return {
                ok: false,
                err: new Error('LmMultichannelSDK: direct: operation not allowed by' +
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (!options.allow.op.includes('graphql')) {
            return {
                ok: false,
                err: new Error('LmMultichannelSDK: graphql: operation not allowed by' +
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('LmMultichannelSDK: graphql: ' +
    ...
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    MessageEvent(entopts) {
        const self = this;
        return new MessageEventEntity_1.MessageEventEntity(self, entopts);
    }
    ...
    SelfAdmin(entopts) {
        const self = this;
        return new SelfAdminEntity_1.SelfAdminEntity(self, entopts);
    }
    ...
    Traffic(entopts) {
        const self = this;
        return new TrafficEntity_1.TrafficEntity(self, entopts);
    }
    ...
    TrafficFile(entopts) {
        const self = this;
        return new TrafficFileEntity_1.TrafficFileEntity(self, entopts);
    }
    ...
    Variable(entopts) {
        const self = this;
        return new VariableEntity_1.VariableEntity(self, entopts);
    }
    static test(testoptsarg, sdkoptsarg) {
        ...
        const testsdk = new LmMultichannelSDK(sdkopts);
        testsdk._mode = 'test';
        return testsdk;
    }
    tester(testopts, sdkopts) {
        return LmMultichannelSDK.test(testopts, sdkopts);
    }
    toJSON() {
        return { name: 'LmMultichannel' };
    }
    toString() {
        return 'LmMultichannel ' + this._utility.struct.jsonify(this.toJSON());
    }
    [node_util_1.inspect.custom]() {
        return this.toString();
    }
}
exports.LmMultichannelSDK = LmMultichannelSDK;
const SDK = LmMultichannelSDK;
exports.SDK = SDK;
//# sourceMappingURL=LmMultichannelSDK.js.map