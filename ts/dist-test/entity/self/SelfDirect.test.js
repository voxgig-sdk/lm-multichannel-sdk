...
(0, node_test_1.describe)('SelfDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-self', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-self', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LM_MULTICHANNEL_TEST_SELF_ENTID'];
...
//# sourceMappingURL=SelfDirect.test.js.map