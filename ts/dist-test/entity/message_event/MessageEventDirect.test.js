...
(0, node_test_1.describe)('MessageEventDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-message_event', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-message_event', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["message_event01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LM_MULTICHANNEL_TEST_MESSAGE_EVENT_ENTID'];
...
//# sourceMappingURL=MessageEventDirect.test.js.map