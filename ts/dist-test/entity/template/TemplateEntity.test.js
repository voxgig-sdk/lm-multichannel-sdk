...
(0, node_test_1.describe)('TemplateEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set LM_MULTICHANNEL_TEST_TEMPLATE_ENTID JSON to run live');
            return;
        }
        ...
        (0, node_assert_1.default)(null != template_ref01_data);
        // LIST
        ...
        (0, node_assert_1.default)(null != template_ref01_resdata_up0);
...
function basicSetup(extra) {
    ...
    let idmap = transform(['template01', 'template02', 'template03', 'review01', 'review02', 'review03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['LM_MULTICHANNEL_TEST_TEMPLATE_ENTID'];
