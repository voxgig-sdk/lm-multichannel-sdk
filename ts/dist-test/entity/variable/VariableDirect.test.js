...
(0, node_test_1.describe)('VariableDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-variable', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-variable', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["template01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LM_MULTICHANNEL_TEST_VARIABLE_ENTID'];
...
//# sourceMappingURL=VariableDirect.test.js.map