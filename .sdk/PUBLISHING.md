...
|---|---|---|
| `ts/` | @voxgig-sdk/lm-multichannel | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/lm-multichannel \
      --repository voxgig-sdk/lm-multichannel-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/lm-multichannel` shows it, and
`npm trust revoke @voxgig-sdk/lm-multichannel --id=<id>` removes it.
