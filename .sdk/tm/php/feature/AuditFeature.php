...
// LmMultichannel SDK audit feature
...
class LmMultichannelAuditFeature extends LmMultichannelBaseFeature
{
    ...
    private function _emit(LmMultichannelContext $ctx, string $outcome): void
    {
