...
// LmMultichannel SDK timeout feature
...
class LmMultichannelTimeoutFeature extends LmMultichannelBaseFeature
{
    ...
    private function _with_timeout(LmMultichannelContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(LmMultichannelContext $_ctx, float $ms): void
    {
        $client = $this->client;
