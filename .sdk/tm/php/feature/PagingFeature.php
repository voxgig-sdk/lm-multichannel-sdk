...
// LmMultichannel SDK paging feature
...
class LmMultichannelPagingFeature extends LmMultichannelBaseFeature
{
    ...
    private function _graphql_pre_request(LmMultichannelContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(LmMultichannelContext $ctx): bool
    {
