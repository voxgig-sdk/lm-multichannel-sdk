...
// LmMultichannel SDK cache feature
...
class LmMultichannelCacheFeature extends LmMultichannelBaseFeature
{
    ...
    private function _through(LmMultichannelContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
