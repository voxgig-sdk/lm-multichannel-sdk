...
// LmMultichannel SDK rbac feature
...
class LmMultichannelRbacFeature extends LmMultichannelBaseFeature
{
    ...
    private function _required(LmMultichannelContext $ctx): ?string
    {
    ...
    private function _reject(LmMultichannelContext $ctx, string $required): void
    {
    ...
    private function _track(LmMultichannelContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
