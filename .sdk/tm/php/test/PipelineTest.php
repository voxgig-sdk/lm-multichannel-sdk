...
// LmMultichannel SDK pipeline test
//
...
{
    private static function utility(): LmMultichannelUtility
    {
        return new LmMultichannelUtility();
    }
    ...
    private static function ctx(array $over = []): LmMultichannelContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new LmMultichannelContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new LmMultichannelOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof LmMultichannelError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new LmMultichannelOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = LmMultichannelMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new LmMultichannelOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = LmMultichannelMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new LmMultichannelOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = LmMultichannelMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LmMultichannelSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = LmMultichannelMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new LmMultichannelResponse([]),
            'result' => new LmMultichannelResult([]),
        ]);
        [, $err] = LmMultichannelMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new LmMultichannelSpec([]),
            'response' => null,
            'result' => new LmMultichannelResult([]),
        ]);
        [, $err] = LmMultichannelMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new LmMultichannelSpec(['step' => 's']),
            'response' => new LmMultichannelResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new LmMultichannelResult([]),
        ]);
        [, $err] = LmMultichannelMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new LmMultichannelSpec(['step' => 's']),
            'response' => new LmMultichannelResponse(self::resp(200, ['v' => 1])),
            'result' => new LmMultichannelResult([]),
        ]);
        [, $err] = LmMultichannelMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new LmMultichannelSpec(['step' => 's']),
            'response' => new LmMultichannelResponse(self::resp(200, ['v' => 2])),
            'result' => new LmMultichannelResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        LmMultichannelMakeResponse::call($ctx);
    ...
    {
        $preset = new LmMultichannelResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new LmMultichannelSpec([]),
            'response' => new LmMultichannelResponse([]),
            'result' => new LmMultichannelResult([]),
        ...
        [$got, $err] = LmMultichannelMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new LmMultichannelResult([])]);
        [, $err] = LmMultichannelMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new LmMultichannelSpec([]), 'result' => null]);
        [, $err] = LmMultichannelMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LmMultichannelSpec(['step' => 's']),
            'result' => new LmMultichannelResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new LmMultichannelOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LmMultichannelMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LmMultichannelSpec(['step' => 's']),
            'result' => new LmMultichannelResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new LmMultichannelOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LmMultichannelMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LmMultichannelResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new LmMultichannelSpec([]),
            'result' => new LmMultichannelResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = LmMultichannelMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = LmMultichannelMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new LmMultichannelError('boom', 'boom');
        $utility->fetcher = function (LmMultichannelContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LmMultichannelSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = LmMultichannelMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (LmMultichannelContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = LmMultichannelMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(LmMultichannelResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        LmMultichannelMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (LmMultichannelContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LmMultichannelSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = LmMultichannelMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new LmMultichannelResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new LmMultichannelSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = LmMultichannelMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = LmMultichannelMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = LmMultichannelMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new LmMultichannelResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, LmMultichannelDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new LmMultichannelResult(['ok' => false])]);
        $this->expectException(LmMultichannelError::class);
        LmMultichannelDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new LmMultichannelResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', LmMultichannelMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        LmMultichannelMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new LmMultichannelBaseFeature();
        $b = new LmMultichannelBaseFeature();
        LmMultichannelFeatureAdd::call($ctx, $a);
        LmMultichannelFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): LmMultichannelBaseFeature
    {
        $f = new LmMultichannelBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        LmMultichannelFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): LmMultichannelContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new LmMultichannelSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = LmMultichannelPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        LmMultichannelPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new LmMultichannelResponse(['headers' => null]),
            'result' => new LmMultichannelResult([]),
        ]);
        LmMultichannelResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        LmMultichannelResultBody::call($ctx);
