...
// LmMultichannel SDK utility: fetcher

class LmMultichannelFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; LmMultichannelSDK/1.0)';
    ...
    public static function call(LmMultichannelContext $ctx, string $fullurl, array $fetchdef): array
    {
