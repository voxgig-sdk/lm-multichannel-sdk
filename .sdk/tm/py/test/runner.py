...
class LmMultichannelTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LmMultichannelTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = LmMultichannelTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = LmMultichannelTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
