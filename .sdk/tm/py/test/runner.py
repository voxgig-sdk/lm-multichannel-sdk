...
class LmMultichannelTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LmMultichannelTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = LmMultichannelTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = LmMultichannelTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
