...
from projectname_sdk import LmMultichannelSDK
from projectname_sdk.core.spec import LmMultichannelSpec
from projectname_sdk.core.result import LmMultichannelResult
from projectname_sdk.core.response import LmMultichannelResponse
from projectname_sdk.core.operation import LmMultichannelOperation
from projectname_sdk.core.error import LmMultichannelError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import LmMultichannelBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return LmMultichannelError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = LmMultichannelSDK.test(None, None)
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except LmMultichannelError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = LmMultichannelResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = LmMultichannelSDK.test(None, None)
        ...
        class TestInitFeature(LmMultichannelBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(LmMultichannelBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = LmMultichannelSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = LmMultichannelSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = LmMultichannelSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = LmMultichannelOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = LmMultichannelSDK.test(None, setup_opts)
