...
from projectname_sdk.core.control import LmMultichannelControl
...
class LmMultichannelContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = LmMultichannelControl()
        ...
        if isinstance(sp, LmMultichannelSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, LmMultichannelResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, LmMultichannelResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return LmMultichannelOperation({})
    ...
    def make_error(self, code, msg):
        return LmMultichannelError(code, msg, self)
