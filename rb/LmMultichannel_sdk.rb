...
require_relative 'LmMultichannel_types'
...
class LmMultichannelSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = LmMultichannelHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = LmMultichannelHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, LmMultichannelFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    LmMultichannelUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = LmMultichannelHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = LmMultichannelHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = LmMultichannelHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
    ...
    ctx.spec = LmMultichannelSpec.new({
  ...
  def raw_request(fetchargs = {})
    ...
    rescue LmMultichannelError => err
    ...
    if fetched.is_a?(Hash)
      status = LmMultichannelHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = LmMultichannelError.new(
        "graphql_error", "LmMultichannelSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  # Canonical facade: client.MessageEvent.list / client.MessageEvent.load({ "id" => ... })
  def MessageEvent(data = nil)
    require_relative 'entity/message_event_entity'
    MessageEventEntity.new(self, data)
  end
  ...
  # Canonical facade: client.SelfAdmin.list / client.SelfAdmin.load({ "id" => ... })
  def SelfAdmin(data = nil)
    require_relative 'entity/self_admin_entity'
    SelfAdminEntity.new(self, data)
  end
  ...
  # Canonical facade: client.Traffic.list / client.Traffic.load({ "id" => ... })
  def Traffic(data = nil)
    require_relative 'entity/traffic_entity'
    TrafficEntity.new(self, data)
  end


  # Canonical facade: client.TrafficFile.list / client.TrafficFile.load({ "id" => ... })
  def TrafficFile(data = nil)
    require_relative 'entity/traffic_file_entity'
    TrafficFileEntity.new(self, data)
  end


  # Canonical facade: client.Variable.list / client.Variable.load({ "id" => ... })
  def Variable(data = nil)
    require_relative 'entity/variable_entity'
    VariableEntity.new(self, data)
  end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = LmMultichannelSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
