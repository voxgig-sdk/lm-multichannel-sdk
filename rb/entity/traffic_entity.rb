...
class TrafficEntity
  ...
  def make
    opts = @_entopts.dup
    TrafficEntity.new(@_client, opts)
  end
  ...
  # @return [Traffic, Hash] the current Traffic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Traffic fields)
  def match_get
  ...
  #
  # @param reqmatch [TrafficRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Traffic, Hash] the removed Traffic; raises LmMultichannelError on failure
