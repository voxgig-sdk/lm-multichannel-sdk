...
class MessageEventEntity
  ...
  def make
    opts = @_entopts.dup
    MessageEventEntity.new(@_client, opts)
  end
  ...
  # @return [MessageEvent, Hash] the current MessageEvent data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MessageEvent fields)
  def match_get
  ...
  #
  # @param reqmatch [MessageEventListMatch, Hash, nil] match filter (any subset of
  #   MessageEvent fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<MessageEvent>, Array] the matching MessageEvent items; raises LmMultichannelError on failure
