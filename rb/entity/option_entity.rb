# LmMultichannel SDK Option entity
...
class OptionEntity
  ...
  #
  # @param reqmatch [OptionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Option.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Option, Hash] the loaded Option; raises LmMultichannelError on failure
  ...
  # Create a new Option.
  #
  # @param reqdata [OptionCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Option, Hash] the created Option; raises LmMultichannelError on failure
  ...
  #
  # @param reqdata [OptionUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Option, Hash] the updated Option; raises LmMultichannelError on failure
