...
class SelfEntity
  ...
  # Load a single Self.
  #
  # @param reqmatch [SelfLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Self.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Self, Hash] the loaded Self; raises LmMultichannelError on failure
