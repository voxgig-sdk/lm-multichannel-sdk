# LmMultichannel SDK Template entity
...
class TemplateEntity
  ...
  # @return [Template, Hash] the loaded Template; raises LmMultichannelError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Template>, Array] the matching Template items; raises LmMultichannelError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Template, Hash] the created Template; raises LmMultichannelError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Template, Hash] the updated Template; raises LmMultichannelError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Template, Hash] the removed Template; raises LmMultichannelError on failure
