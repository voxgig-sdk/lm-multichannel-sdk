...
class VariableEntity
  ...
  def make
    opts = @_entopts.dup
    VariableEntity.new(@_client, opts)
  end
  ...
  # @return [Variable, Hash] the current Variable data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Variable fields)
  def match_get
  ...
  #
  # @param reqmatch [VariableListMatch, Hash, nil] match filter (any subset of
  #   Variable fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Variable>, Array] the matching Variable items; raises LmMultichannelError on failure
  ...
  #
  # @param reqdata [VariableCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Variable, Hash] the created Variable; raises LmMultichannelError on failure
  ...
  #
  # @param reqdata [VariableUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Variable, Hash] the updated Variable; raises LmMultichannelError on failure
