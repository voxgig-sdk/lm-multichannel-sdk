...
class ScheduleEntity
  ...
  # @return [Schedule, Hash] the loaded Schedule; raises LmMultichannelError on failure
  ...
  #
  # @param reqmatch [ScheduleRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Schedule, Hash] the removed Schedule; raises LmMultichannelError on failure
