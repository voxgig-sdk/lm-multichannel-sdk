...
class SelfAdminEntity
  ...
  def make
    opts = @_entopts.dup
    SelfAdminEntity.new(@_client, opts)
  end
  ...
  # @return [SelfAdmin, Hash] the current SelfAdmin data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SelfAdmin fields)
  def match_get
  ...
  #
  # @param reqdata [SelfAdminUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [SelfAdmin, Hash] the updated SelfAdmin; raises LmMultichannelError on failure
