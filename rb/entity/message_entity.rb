# LmMultichannel SDK Message entity
...
class MessageEntity
  ...
  # @return [Message, Hash] the loaded Message; raises LmMultichannelError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Message, Hash] the created Message; raises LmMultichannelError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Message, Hash] the removed Message; raises LmMultichannelError on failure
