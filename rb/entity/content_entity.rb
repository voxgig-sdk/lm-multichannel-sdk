# LmMultichannel SDK Content entity
...
class ContentEntity
  ...
  # @return [Content, Hash] the loaded Content; raises LmMultichannelError on failure
  ...
  #
  # @param reqdata [ContentCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Content, Hash] the created Content; raises LmMultichannelError on failure
